...
export const eventData = [
  ...
  { title: 'Darsa by Sheikh Abu Ambar', date: 'Saturday, 19 September 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'A scheduled darsa session with Sheikh Abu Ambar.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Hospital Visit', date: 'Saturday, 26 September 2026', time: 'To be announced', location: 'Maseno Mission Hospital and Coptic Hospital', description: 'A MUMSA welfare visit to offer care, encouragement and support.', category: 'Student Welfare', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Internal Darsa', date: 'Saturday, 3 October 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'An internal MUMSA darsa session for learning and reflection.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Darsa by Sheikh Abu Ambar', date: 'Saturday, 10 October 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'A scheduled darsa session with Sheikh Abu Ambar.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  ...
  { title: 'Internal Darsa', date: 'Saturday, 24 October 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'An internal MUMSA darsa session for learning and reflection.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Darsa by Sheikh Abu Ambar', date: 'Saturday, 31 October 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'A scheduled darsa session with Sheikh Abu Ambar.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Internal Darsa', date: 'Saturday, 7 November 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'An internal MUMSA darsa session for learning and reflection.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Darsa by Sheikh Abu Ambar', date: 'Saturday, 14 November 2026', time: '8:00 AM', location: 'Masjid Siriba', description: 'A scheduled darsa session with Sheikh Abu Ambar.', category: 'Islamic Development', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Brothers’ Hike', date: 'Saturday, 21 November 2026', time: 'To be announced', location: 'Kima Hills', description: 'A MUMSA outdoor activity for brothers, focused on fellowship and wellbeing.', category: 'Social & Recreational', image: null, registrationUrl: null, status: 'Upcoming' },
  { title: 'Sisters’ Hike', date: 'Sunday, 22 November 2026', time: 'To be announced', location: 'Kima Hills', description: 'A MUMSA outdoor activity for sisters, focused on fellowship and wellbeing.', category: 'Social & Recreational', image: null, registrationUrl: null, status: 'Upcoming' },
